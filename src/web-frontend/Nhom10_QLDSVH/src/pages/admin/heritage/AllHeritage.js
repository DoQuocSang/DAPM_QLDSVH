                                    ...
                                    <div className="overflow-x-auto rounded-lg">
                                        <div className="align-middle inline-block min-w-full">
                                            <div className="shadow overflow-hidden sm:rounded-lg">
                                                    ...
                                                    <tbody className="bg-white">
                                                        {heritageList.map((item, index) => (
                                                            <tr className={index % 2 !== 0 && "bg-gray-100"}>
                                                                ...
                                                                <th scope="col" onClick={() => { alert('alert'); }} className="p-4 text-left text-xl font-semibold text-red-400 uppercase tracking-wider">
                                                ...
                                                <div scope="col" id="delete_buttonmodal" className="cursor-pointer p-4 text-left text-xl font-semibold text-red-400 uppercase tracking-wider hover:text-red-600 transition duration-75">
                                                    <FontAwesomeIcon icon={faTrash} />
                                                </div>
