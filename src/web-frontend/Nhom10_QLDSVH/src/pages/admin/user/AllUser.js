...
import { getUsers, getUsersByQuerySearch } from "../../../services/UserRepository";
                ...
                <div className="mb-4 flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-base font-normal text-gray-500">
                      Các tài khoản hiện có trong database
                    </span>
                  </div>
                              ...
                              <tr className={index % 2 !== 0 && "bg-gray-100"}>
                                ...
                                {item.permission === 0 ? (
                                  <>
                                    ...
                                    >
                                      <Link
                                        to={`/admin/dashboard/update-user/${item.id}`}
                                      >
                                  ...
                                  <>
                                    ...
                                    <th
                                      scope="col"
                                      className="p-4 text-left text-xl font-semibold text-gray-400 uppercase tracking-wider hover:text-emerald-600 transition duration-75"
                                    >
                                      <Link to={`#`}>
                                        <FontAwesomeIcon icon={faPenToSquare} />
                                      </Link>
                                    ...
                                    <th
                                      scope="col"
                                      className="cursor-pointer p-4 text-left text-xl font-semibold text-gray-400 uppercase tracking-wider hover:text-red-600 transition duration-75"
                                    >
                                      <FontAwesomeIcon icon={faTrash} />
                                    </th>
                                  </>
