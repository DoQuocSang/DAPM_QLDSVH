...
import { getTagById } from "../../../services/TagRepository";
import { addOrUpdateTag } from "../../../services/TagRepository";


export default  ({ type = "" }) => {

    let mainText = AddOrUpdateText(type, "thẻ");
    const initialState = {
        id: 0,
        name: '',
        description: '',
                ...
                <div className="mt-12 px-4">
                    <div className="editor mx-auto flex w-10/12 max-w-2xl flex-col p-6 text-gray-800 shadow-lg mb-12 rounded-lg border-t-4 border-purple-400">
                        ...
                        <div className="buttons flex">
                            <hr className="mt-4" />
                            <Link to="/admin/dashboard/all-tag" className="btn ml-auto rounded-md transition duration-300 ease-in-out cursor-pointer hover:bg-gray-500 p-2 px-5 font-semibold hover:text-white text-gray-500">
                                Hủy
                            </Link>
